...
export const OnlineForm: FC<OnlineFormProps> = ({ record, reloadData }) => {
    ...
    const { fetchData: _fetchBackMarkerCreditt } = useHttp<string, null>(
        backMarkerCredit,
        ({ msg }) => {
            message.success(msg);
            reloadData();
                    ...
                    <FormCurrency
                        ...
                        addonAfter={
                            <AuthButton
                                ...
                                secondVerify={(val) => {
                                    if (val) {
                                        _fetchBackMarkerCreditt(record.id);
                                    }
                                }}
                            ></AuthButton>
                        }
