...
import { Row, Col, Spin, Empty, message, Popover, Typography } from 'antd';
import VirtualList from 'rc-virtual-list';
import { ModalForm } from '@ant-design/pro-components';
import { useHttp } from '@/hooks';
import { getIntegralDetail } from '@/api/service';
import { IntegralDetailParams } from '@/types/api/service';
...
const IntegraListDetail: FC<ConsumDetailProps> = (props) => {
    const { fetchData: fetchGetIntegralDetail } = useHttp<
    ...
    return (
            ...
            trigger={
                <div
                    className={`${'m-primary-font-color pointer'}${
                        !record.this_month_consume ? ' disabled' : ''
                    }`}
                >
                    详情
                </div>
        ...
        >
            <Row>
                ...
                <Col span={8}>
                    <div style={style}>户口名：{record.account_name}</div>
                </Col>
            </Row>
            <Row>
                <Col span={8}>
...
export default IntegraListDetail;
